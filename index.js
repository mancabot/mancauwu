...
const wa = 'https://chat.whatsapp.com/JL2P1ez4crxC9mFIVlmZEf';
const eror = 'Info fitur Error';
const ow = 'Nurul';
const nomorowner = '083815956151';
const ovo = '083815956151';
const pulsa = '083815956151';
const dana = '083815956151';
const instagram = 'http://www.instagram.com/thenay_xploit_';
...
conn.on('qr', qr => {
  ...
  console.log(`[ ${moment().format("HH:mm:ss")} ] MancaBot Ready scan now!`);
});
...
setInterval(function () {
  for (i = 0; i < 3; i++) {
    console.log(`[ ${moment().format("HH:mm:ss")} ] => HI! I'm MancaBot :)`)
  }
}, 15000)
...
conn.on('message-new', async (m) => {
  ...
  if (text.includes('.Map')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil,\n_contoh : .map banten_', MessageType.text, { quoted: m });
  }
  if (text.includes('.map')) {
...
╠════════════════════` , MessageType.text);
  ...
  if (text.includes('.Nulis')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .nulis Nurul love FX_', MessageType.text, { quoted: m });
  }
  //Pengucapan ulang
  if (text.includes('.Say')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .say Fx gans_', MessageType.text, { quoted: m });
  }
  if (text.includes(".say")) {
  ...
  if (text.includes('.Thunder')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .thunder Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.thunder')) {
  ...
  if (text.includes('.Sand1')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand1 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand1')) {
  ...
  if (text.includes('.Neon3d')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon3d Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon3d')) {
  ...
  if (text.includes('.Blackpink')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Blackpink Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.blackpink')) {
  ...
  if (text.includes('.Cloud')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .cloud Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.cloud')) {
  ...
  if (text.includes('.Sky')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sky Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sky')) {
  ...
  if (text.includes('.Sand2')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand2 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand2')) {
  ...
  if (text.includes('.Sand3')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand3 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand3')) {
  ...
  if (text.includes('.Sand4')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .sand4 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand4')) {
  ...
  if (text.includes('.Balon')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .balon Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.balon')) {
  ...
  if (text.includes('.Metal')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .metal Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.metal')) {
  ...
  if (text.includes('.Old')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .old Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.old')) {
  ...
  if (text.includes('.Holo')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .holo Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.holo')) {
  ...
  if (text.includes('.Coding')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .coding Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.coding')) {
  ...
  if (text.includes('.Neon4')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon4 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon4')) {
  ...
  if (text.includes('.Neon5')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon5 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon5')) {
...
Zulu = zu` , MessageType.text, { quoted: m });
  ...
  if (text.includes('.Rate')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .rate seberapa ganteng FX_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Paper1')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .paper1 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.paper1')) {
  ...
  if (text.includes('.Block')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .block Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.block')) {
  ...
  if (text.includes('.Heart')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .heart Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.heart')) {
  ...
  if (text.includes('.Grass')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .grass Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.grass')) {
  ...
  if (text.includes('.Ocean')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .ocean Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.ocean')) {
  ...
  if (text.includes('.Board')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .board Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.board')) {
  ...
  if (text.includes('.Mwolf')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .mwolf Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.mwolf')) {
  ...
  if (text.includes('.Mglow')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .mglow Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.mglow')) {
  ...
  if (text.includes('.Bit8')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .bit8 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.bit8')) {
  ...
  if (text.includes('.Hpotter')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Hpotter Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.hpotter')) {
  ...
  if (text.includes('.Pubg')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .pubg Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.pubg')) {
  ...
  if (text.includes('.Cfire')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Cfire Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.cfire')) {
  ...
  if (text.includes('.Wface1')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Wface1 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.wface1')) {
  ...
  if (text.includes('.Wface2')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Wface2 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.wface2')) {
  ...
  if (text.includes('.Battlef')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Battlef Nurul_', MessageType.text, { quoted: m });
  }
  ...
  if (text.includes('.Lol')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .lol Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.lol')) {
  ...
  if (text.includes('.Csgo')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .csgo Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.csgo')) {
  ...
  if (text.includes('.Owatch')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Owatch Nurul_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Paper2')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .paper2 Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.paper2')) {
  ...
  if (text.includes('.Coffee')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .coffee Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.coffee')) {
  ...
  if (text.includes('.Shadow')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .shadow Nurul_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Fontgen')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .fontgen Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes(".fontgen")) {
  ...
  if (text.includes('.Alay')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .alay Nurul sayang Fx_', MessageType.text, { quoted: m });
  }
  if (text.includes(".alay")) {
  ...
  if (text.includes('.Stalk')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .stalk @thenay_xploit_', MessageType.text, { quoted: m });
  }
  if (text.includes(".stalk")) {
  ...
  if (text.includes('.Namae')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .namae Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes(".namae")) {
  ...
  if (text.includes('.Logopornhub')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .logopornhub Nurul/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.logopornhub')) {
  ...
  if (text.includes('.Ninja')) {
    ...
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .ninja Nurul/nime_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Wolf')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .wolf Nurul/nime_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Lion')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .lion Nurul/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.lion')) {
  ...
  if (text.includes('.Glitch')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .glitch Nurul/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.glitch')) {
  ...
  if (text.includes('.Joker')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .joker Nurul_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Blood')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .blood Nurul_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Water')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .water Nurul_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Neon')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .neon2 Nurul_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Snow')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .Snow Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.snow')) {
  ...
  if (text.includes('.Kata')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .kata matamu indah bagai pelangi/Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes('.kata')) {
  ...
  if (text.includes('.Getzodiak')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .getzodiak Nurul & 09-09-2001_', MessageType.text, { quoted: m });
  }
  if (text.includes('.getzodiak')) {
  ...
  if (text.includes('.Couple')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .couple Nurul & Fx_', MessageType.text, { quoted: m });
  }
  if (text.includes('.couple')) {
  ...
  if (text.includes('.Arti')) {
    conn.sendMessage(id, 'Silakan ulangi command dengan huruf kecil\n_contoh : .arti Nurul_', MessageType.text, { quoted: m });
  }
  if (text.includes(".arti")) {
...
╠════════════════════
╠≽ *.Kata (quotes/author)*
╠ _Ex = .Kata Aku cinta dia/Nurul_ 
╠≽ *.Logopornhub (teks1/teks2)*
╠ _Ex : .Logopornhub Nurul/nime_
╠≽ *.Lion (teks1/teks2)*
╠ _Ex : .Lion Nurul/nime_
╠≽ *.Ninja (teks1/teks2)*
╠ _Ex : .Ninja Nurul/nime_
╠≽ *.Joker (teks1/teks2)*
╠ _Ex : .Joker Nurul/nime_
╠≽ *.Glitch (teks1/teks2)*
╠ _Ex : .Glich Nurul/nime_
╠≽ *.Wolf (teks1/teks2)*
╠ _Ex : .Wolf Nurul/nime_
╠≽ *.Snow (teks)*
╠ _Ex : .Snow Nurul_
╠≽ *.Neon1 (teks)*
╠ _Ex : .Neon1 Nurul_
...
╠════════════════════
╠≽ *.Bit8 (text/text)*
╠ _Ex = .Bit8 Nurul/nime_ 
╠≽ *.Pubg (teks1/teks2)*
╠ _Ex : .Pubg Nurul/nime_
╠≽ *.Batllef (teks1/teks2)*
╠ _Ex : .Battlef Nurul/nime_
╠≽ *.Shadow (teks)*
╠ _Ex : .Shadow Nurul_
╠≽ *.Paper1 (teks)*
╠ _Ex : .Paper Nurul_
...
╠≽️ *.Nulis*
╠ _Ex = .Nulis aku cinta Nurul_ 
╠≽️ *.Ocr*
╠ _Mencopy kalimat di gambar_ 
╠≽️ *.Stalk (username ig)*
╠ _Ex = .Stalk @thenay_xploit_ 
╠≽️ *.Shortlink (link)*
╠ _Pemendek link_ 
╠≽️ *.ssweb (link)*
╠ _Screenshoot Web_
...
╠ _Ex = .Arti Nurul_ 
╠≽️ *.Couple (Namamu & doi)*
╠ _Ex = .Couple Nurul & udan_ 
╠≽️ *.Getzodiak (Nama & tgl)
╠ _Ex : .Getzodiak Nurul & 09-09-2001_ 
